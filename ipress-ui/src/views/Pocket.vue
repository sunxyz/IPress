      ...
      <Sider collapsible :collapsed-width="78" v-model="isCollapsed" :width="300" :style="{background: '#fff'}">
          ...
          <div style="margin-top:15px;display: flex;justify-content: space-between">
            <div>
              <Tooltip content="主页" placement="left">
                <Button shape="circle"  icon="ios-home-outline" style="margin: 5px 0px" @click="$router.push({name:'home'})"></Button>
              </Tooltip>
            </div>
            <div>
              <Tooltip content="新建目录" placement="left">
                <Button shape="circle" type="primary" icon="ios-folder-outline" style="margin: 5px 8px" @click="openFolderDrawer"></Button>
              </Tooltip>
              <Tooltip content="新建页面" placement="right">
                <Button shape="circle" type="primary" icon="ios-add" style="margin: 5px  0 5px 8px" @click="openPageDrawer"></Button>
              </Tooltip>
            </div>
        ...
        <Menu :active-name="activeMenuName"  width="auto" :class="menuitemClasses">
          ...
          <Submenu name="2">
            ...
            <MenuGroup title="Item 1">
              <MenuItem name="1-1"><Icon type="ios-document-outline" />Option 1</MenuItem>
              <MenuItem name="1-2"><Icon type="ios-document-outline" />Option 2</MenuItem>
            </MenuGroup>
            <MenuGroup title="Item 2">
              <MenuItem name="1-3"><Icon type="ios-document-outline" />Option 3</MenuItem>
              <MenuItem name="1-4"><Icon type="ios-document-outline" />Option 4</MenuItem>
            </MenuGroup>
          </Submenu>
